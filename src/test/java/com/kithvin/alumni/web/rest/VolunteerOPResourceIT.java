...
class VolunteerOPResourceIT {
    ...
    private static final Instant DEFAULT_TIME_DURATION = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_TIME_DURATION = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    private VolunteerOP insertedVolunteerOP;
    ...
    @AfterEach
    public void cleanup() {
        if (insertedVolunteerOP != null) {
            volunteerOPRepository.delete(insertedVolunteerOP);
            insertedVolunteerOP = null;
        }
    }
    ...
    void createVolunteerOP() throws Exception {
        ...
        insertedVolunteerOP = returnedVolunteerOP;
    }
    ...
    void getAllVolunteerOPS() throws Exception {
        ...
        insertedVolunteerOP = volunteerOPRepository.saveAndFlush(volunteerOP);
        ...
        restVolunteerOPMockMvc
            ...
            .andExpect(jsonPath("$.[*].timeDuration").value(hasItem(DEFAULT_TIME_DURATION.toString())))
    ...
    void getVolunteerOP() throws Exception {
        ...
        restVolunteerOPMockMvc
            ...
            .andExpect(jsonPath("$.timeDuration").value(DEFAULT_TIME_DURATION.toString()))
    ...
    void partialUpdateVolunteerOPWithPatch() throws Exception {
        ...
        partialUpdatedVolunteerOP.location(UPDATED_LOCATION).timeDuration(UPDATED_TIME_DURATION);
