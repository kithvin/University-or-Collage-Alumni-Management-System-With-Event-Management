...
class DonationResourceIT {
    ...
    private static final Instant DEFAULT_AMOUNT = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_AMOUNT = Instant.now().truncatedTo(ChronoUnit.MILLIS);
