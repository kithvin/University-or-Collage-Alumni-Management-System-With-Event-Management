...
class NewsResourceIT {
    ...
    private static final Instant DEFAULT_COVER_AREA = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_COVER_AREA = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    void getAllNews() throws Exception {
        ...
        restNewsMockMvc
            ...
            .andExpect(jsonPath("$.[*].coverArea").value(hasItem(DEFAULT_COVER_AREA.toString())))
    ...
    void getNews() throws Exception {
        ...
        restNewsMockMvc
            ...
            .andExpect(jsonPath("$.coverArea").value(DEFAULT_COVER_AREA.toString()))
    ...
    void partialUpdateNewsWithPatch() throws Exception {
        ...
        partialUpdatedNews.title(UPDATED_TITLE).coverArea(UPDATED_COVER_AREA).group(UPDATED_GROUP);
