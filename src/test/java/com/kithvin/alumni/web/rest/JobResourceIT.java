...
class JobResourceIT {
    ...
    private static final Instant DEFAULT_SALARY_DETAILS = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_SALARY_DETAILS = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    void getAllJobs() throws Exception {
        ...
        restJobMockMvc
            ...
            .andExpect(jsonPath("$.[*].salaryDetails").value(hasItem(DEFAULT_SALARY_DETAILS.toString())))
    ...
    void getJob() throws Exception {
        ...
        restJobMockMvc
            ...
            .andExpect(jsonPath("$.salaryDetails").value(DEFAULT_SALARY_DETAILS.toString()))
    ...
    void partialUpdateJobWithPatch() throws Exception {
        ...
        partialUpdatedJob.companyName(UPDATED_COMPANY_NAME).salaryDetails(UPDATED_SALARY_DETAILS);
