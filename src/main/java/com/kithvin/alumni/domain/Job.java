...
public class Job implements Serializable {
    ...
    public Instant getSalaryDetails() {
        return this.salaryDetails;
    }

    public Job salaryDetails(Instant salaryDetails) {
        this.setSalaryDetails(salaryDetails);
        return this;
    }

    public void setSalaryDetails(Instant salaryDetails) {
    ...
    public Job expireDate(Instant expireDate) {
