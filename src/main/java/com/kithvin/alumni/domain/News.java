...
public class News implements Serializable {
    ...
    public Instant getCoverArea() {
        return this.coverArea;
    }

    public News coverArea(Instant coverArea) {
        this.setCoverArea(coverArea);
        return this;
    }

    public void setCoverArea(Instant coverArea) {
    ...
    public News expireDate(Instant expireDate) {
