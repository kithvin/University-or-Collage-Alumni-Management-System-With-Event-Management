...
public class VolunteerOP implements Serializable {
    ...
    public VolunteerOP dateAndTime(Instant dateAndTime) {
    ...
    public Instant getTimeDuration() {
        return this.timeDuration;
    }

    public VolunteerOP timeDuration(Instant timeDuration) {
        this.setTimeDuration(timeDuration);
        return this;
    }

    public void setTimeDuration(Instant timeDuration) {
