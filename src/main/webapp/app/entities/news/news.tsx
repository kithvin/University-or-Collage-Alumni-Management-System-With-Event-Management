...
export const News = () => {
  ...
  const totalItems = useAppSelector(state => state.news.totalItems);
            ...
            <tbody>
              {newsList.map((news, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{news.title}</td>
                  <td>{news.publishDate ? <TextFormat type="date" value={news.publishDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{news.coverArea ? <TextFormat type="date" value={news.coverArea} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{news.group}</td>
                  <td>{news.expireDate ? <TextFormat type="date" value={news.expireDate} format={APP_DATE_FORMAT} /> : null}</td>
