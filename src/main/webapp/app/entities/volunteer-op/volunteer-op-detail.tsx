    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {volunteerOPEntity.dateAndTime ? (
              <TextFormat value={volunteerOPEntity.dateAndTime} type="date" format={APP_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
          ...
          <dd>
            {volunteerOPEntity.timeDuration ? (
              <TextFormat value={volunteerOPEntity.timeDuration} type="date" format={APP_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
